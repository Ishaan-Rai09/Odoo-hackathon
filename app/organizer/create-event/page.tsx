                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="border-2 border-dashed border-white/20 rounded-lg p-8 text-center">
                        ...
                        <p className="text-white/60 mb-4">Upload event cover image</p>
              ...
              {currentStep === 3 && (
                <Card className="glassmorphism">
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div className="space-y-2">
                      <Label className="text-white">Location on Map</Label>
                      <div className="bg-white/10 rounded-lg h-64 flex items-center justify-center border border-white/20">
                        <div className="text-center">
                          ...
                          <p className="text-white/60 mb-4">Google Maps integration will be displayed here</p>
