  ...
  const loadAnalytics = async () => {
    ...
    try {
      ...
      const mockAnalytics: EventAnalytics = {
        ...
        dailyBookings: [
          { date: '2024-01-01', bookings: 15, revenue: 1050 },
          { date: '2024-01-02', bookings: 22, revenue: 1540 },
          { date: '2024-01-03', bookings: 18, revenue: 1260 },
          { date: '2024-01-04', bookings: 25, revenue: 1750 },
          { date: '2024-01-05', bookings: 20, revenue: 1400 },
          { date: '2024-01-06', bookings: 12, revenue: 840 },
          { date: '2024-01-07', bookings: 13, revenue: 910 }
        ],
        ticketTypeStats: [
          { type: 'General', sold: 85, revenue: 5950, capacity: 100 },
          { type: 'VIP', sold: 25, revenue: 2500, capacity: 30 },
          { type: 'Student', sold: 15, revenue: 300, capacity: 20 }
        ],
        refundStats: {
          totalRefunds: 7,
          refundAmount: 490,
